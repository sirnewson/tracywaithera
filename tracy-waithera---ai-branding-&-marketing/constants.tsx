...
export const STRINGS: Record<'en' | 'sw', ContentStrings & { 
  ...
  en: {
    ...
    hero: {
      tag: 'BRAND STRATEGY AI SPECIALIST CREATIVE',
...
export const RATE_CARD: RateItem[] = [
  ...
  {
    service: 'AI Brand Audit',
    price: 'KES 25,000',
    details: 'Full review of your digital presence with a detailed AI-driven growth plan.',
    popular: true
  },
  {
...
export const VIDEOS = [
  { title: 'The Future of AI Branding', thumb: 'https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&q=80&w=800' },
  { title: 'Mental Health in Tech', thumb: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&q=80&w=800' },
  { title: 'Marketing Secrets 2025', thumb: 'https://images.unsplash.com/photo-1557804506-669a67965ba0?auto=format&fit=crop&q=80&w=800' },
  { title: 'The Power of Personal Authority', thumb: 'https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&q=80&w=800' },
  { title: 'Building the Trouve Legacy', thumb: 'https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&q=80&w=800' },
  { title: 'Scaling Beyond Borders', thumb: 'https://images.unsplash.com/photo-1559136555-9303baea8ebd?auto=format&fit=crop&q=80&w=800' },
];
