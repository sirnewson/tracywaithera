...
export const STRINGS: Record<'en' | 'sw', ContentStrings & {
  ...
  en: {
    ...
    hero: {
      ...
      subtitle: 'I am a marketer who helps entrepreneurs, founders, and professionals build a great online presence and highly profitable brands. Through Personal Branding Training, Digital Marketing, and AI Marketing, I provide the exact strategies and automated systems you need to turn your expertise into a magnetic brand—scaling locally in Africa and globally.',
...
export const SERVICES = [
  {
    icon: 'Sparkles',
    titleEn: 'Personal Branding Training',
    titleSw: 'Mafunzo ya Chapa Binafsi',
    descEn: 'I provide specialized training to help you build a highly profitable personal brand that people trust.',
    descSw: 'Natoa mafunzo ya kusaidia wafanyabiashara kujenga chapa binafsi zenye faida kubwa.',
    color: 'text-orange-400',
  },
  {
    icon: 'Bot',
    titleEn: 'AI Marketing',
    titleSw: 'Masoko ya AI',
    descEn: 'I build automated AI marketing systems that handle your marketing and bring predictable growth.',
    descSw: 'Najenga mifumo ya masoko ya AI inayojiendesha na mikakati ya dijitali inayoleta ukuaji.',
    color: 'text-purple-400',
  },
  {
    icon: 'Mic',
    titleEn: 'Digital Marketing',
    titleSw: 'Masoko ya Dijitali',
    descEn: 'Comprehensive digital marketing and strategy to scale your brand reach across Africa and globally.',
    descSw: 'Mikakati kamili ya masoko ya dijitali kukuza chapa yako na kuongeza mapato.',
    color: 'text-orange-400',
  },
];
